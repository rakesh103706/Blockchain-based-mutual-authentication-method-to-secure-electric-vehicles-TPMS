...
<head>
<title>Find_Attacker Status Results By Hashcode</title>
...
<%@ page import="java.util.Date" %>
 ...
 <table width="531" height="129" border="3" align="left"  cellpadding="0" cellspacing="0"  style="border-collapse: collapse;  margin:10px 10px 10px 10px; font-family:Verdana, Arial, Helvetica, sans-serif; font-size:14px;">
        <tr>
			  ...
			  <th height="63" bgcolor="#FF0000"><span class="style10 style6 style5 style3 style1"> Electric_Vehicle_ID</span></th>
 <th bgcolor="#FF0000"><span class="style10 style6 style5 style3 style1">Attacker Type </span></th>
        </tr>
