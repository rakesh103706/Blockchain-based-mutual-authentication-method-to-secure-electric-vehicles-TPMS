          ...
          <div class="clr"></div>
            ...
            <form id="form1" name="form1" method="post" action="authentication.jsp?type=<%="user"%>">
              <table width="408" align="left">
                  <tr>
                    <td width="162" height="48" bgcolor="#FF0000"><span class="style5">User Name (required)</span></td>
                    <td width="347"><input id="name" name="userid" class="text" /></td>
                  </tr>
                  <tr>
                    <td height="44" bgcolor="#FF0000"><span class="style5">Password (required)</span></td>
