    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          ...
          <p align="center"><strong><img src="images/User.jpg" width="566" height="221" /></strong></p>
          <div class="clr"></div>
        </div>
        </div>
      <div class="sidebar">
        ...
        <div class="gadget">
          ...
          <ul class="sb_menu">
		   <li><a href="user_profile.jsp">View My Profile </a></li>
			...
			<li><a href="U_Find_Datasets_Results_By_Hashcode.jsp">Find Datasets Results By Hashcode</a></li>
			 <li><a href="U_Find_TPMS_Attacker.jsp">Find TPMS Attacker</a></li>
